...
[IMPORTANT]
Changes to `UNIT` settings can have effects in other areas, such as Camera View settings related to  `Focal Length`, `Clip Start` and `Clip End`. Set in the _N-Panel_ under `View`.
